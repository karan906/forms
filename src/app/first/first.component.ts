...
export class FirstComponent implements OnInit {
  ...
  clickBTN() {
    ...
    }if(this.languages==='' || this.languages===undefined){
      this.languagesError=true;
    
    }if(this.qwalication==='' || this.qwalication===undefined){
      this.qwalicationError=true;
    ...
    this.languages = this.service.setLANGUAGES(this.languages);
    this.qwalication = this.service.setQwalication(this.qwalication);
    // this.router.navigate(["second"])
  }
}
